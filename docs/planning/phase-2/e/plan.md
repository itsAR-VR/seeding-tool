# Phase 2e — “Fusion” site blueprint + implementation backlog (integrated with roadmap)
...
## Inputs
- Outputs from Phase 2d (typography tokens, motion primitives, component catalog).
- Business requirement: not SaaS; funnel and content should resemble a TKS-like admissions/program model.
- Existing roadmap/plans in `docs/planning/` (Phase 1 and any other planning docs that exist).
...
## Handoff
This subphase closes Phase 2 and hands off to implementation work: building the site in Next.js + Tailwind + GSAP using the blueprint and parity tests as the source of truth.
