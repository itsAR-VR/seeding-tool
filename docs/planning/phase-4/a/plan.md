# Phase 4a — Scaffold project + config + output contract
...
## Inputs
- Phase 4 root plan (objectives, constraints, success criteria).
- Existing output conventions referenced in Phase 2:
  - `artifacts/<run-id>/...`
...
## Handoff
Phase 4b reuses the config + capture primitives from this subphase without adding new env vars or changing output conventions.
