# Phase 4b — Implement marketing route discovery + capture pipeline
...
## Inputs
- Phase 4a scaffold: config loader, artifact directories, Playwright config.
- Marketing sources:
...
## Handoff
Phase 4c reuses the same capture primitives but adds a manual auth bootstrap and flow recording for onboarding.
