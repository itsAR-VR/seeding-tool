# Phase 4c — Implement platform bootstrap login + onboarding flow recorder
...
## Inputs
- Phase 4a scaffold + Phase 4b capture primitives.
...
## Handoff
Phase 4d uses the saved `storageState` to crawl the authenticated IA and capture all reachable pages and core flows safely.
