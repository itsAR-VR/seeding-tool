# Phase 5b — Implement shared capture + token/motion/network primitives
...
## Inputs
- Phase 5a scaffold + config contract.
...
## Handoff
Phase 5c should wire these primitives into the marketing and competitor runners, and add route discovery + per-route artifact capture.
