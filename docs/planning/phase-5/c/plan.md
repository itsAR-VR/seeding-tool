# Phase 5c — Implement marketing runners (owned + competitors) + route inventories
...
## Inputs
- Phase 5b shared capture primitives.
- Sites (canonical URLs per Phase 5 root plan):
...
## Handoff
Phase 5d should implement the authenticated app runners (manual OAuth bootstrap + onboarding recorder + IA crawl with HAR capture) using the shared capture primitives.
