# Phase 5a — Scaffold project from scratch + config + output contract
...
## Handoff
Proceed to Phase 5b to implement shared capture primitives (baseline + motion + token/animation extraction + optional network capture) and replace runner placeholders with real logic.
