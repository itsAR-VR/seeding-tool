# Phase 3d — Implement authenticated platform crawl + capture + network logs
...
## Inputs
- `.auth/platform.afterOnboarding.storageState.json` from Phase 3c.
- Capture primitives from Phase 3b.
...
## Handoff
Phase 3e consumes `routes.json`, token/animation inventories, and flow artifacts to update the living Markdown knowledge base and indexes.
