  ...
  return (
    <section style={{ minHeight: "100vh", padding: "4rem 1.5rem" }}>
      ...
      >
        ...
        <h1 style={{ margin: "1rem 0 0", fontSize: "2.5rem", lineHeight: 1.05 }}>Create your workspace</h1>
        <p style={{ maxWidth: "40rem", margin: "0.75rem 0 0", fontSize: "1rem", lineHeight: 1.7, opacity: 0.72 }}>
          Billing, organization bootstrap, and brand onboarding land after the auth substrate is in place. This route is the stable destination for that flow.
        </p>
      </div>
    </section>
  );
