export default function InboxPage() {
  return (
    ...
    >
      ...
      <h1 style={{ margin: "1rem 0 0", fontSize: "2.5rem", lineHeight: 1.05 }}>Inbox scaffold</h1>
      <p style={{ maxWidth: "42rem", margin: "0.75rem 0 0", fontSize: "1rem", lineHeight: 1.7, opacity: 0.72 }}>
        Gmail sync, reply classification, and address extraction land after the data model and auth layers are in place. The shared shell can route here safely now.
      </p>
    </section>
  );
}
